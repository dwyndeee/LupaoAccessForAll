            ...
            <li class="nav-item active">
                ...
                <div id="collapsePagesEmployment" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="employer.jobs.php">Job Openings</a>
                    </div>
                </div>
            </li>
                    ...
                    <form id="addJobForm" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row border rounded p-3 mb-4 bg-light shadow-sm">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="salary" name="salary" placeholder="Salary" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row border rounded p-3 mb-4 bg-light shadow-sm">
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="application_start" name="application_start" placeholder="application_start" required>
                            </div>
                            <div class="col-md-6">
                                <label for="application_deadline" class="form-label">Application Deadline</label>
                                <input type="date" class="form-control" id="application_deadline" name="application_deadline" placeholder="application_deadline" required>
                            </div>
                        </div>
                    ...
                    <form id="editJobForm" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row border rounded p-3 mb-4 bg-light shadow-sm">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="editSalary" name="editSalary" placeholder="Salary" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row border rounded p-3 mb-4 bg-light shadow-sm">
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="editApplication_start" name="editApplication_start" required>
                            </div>
                            <div class="col-md-6">
                                <label for="editApplication_deadline" class="form-label">Application Deadline</label>
                                <input type="date" class="form-control" id="editApplication_deadline" name="editApplication_deadline" required>
                            </div>
                        </div>
