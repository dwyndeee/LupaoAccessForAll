                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="programCount"></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                Employer Users</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="employersCount">18</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">
                                                Applicant Users</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="applicantsCount">18</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Pending Scholar</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="pendingScholarCount">18</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-spinner fa-2x text-gray-300"></i>
                                        </div>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#programCount').text(response.programsCount);
                },
            ...
            $.ajax({
                ...
                dataType: 'json',
                success: function(response) {
                    console.log("Jobs Count:", response.employersCount);
                    // Use the count as needed, for example:
                    $('#employersCount').text(response.employersCount);
                },
                error: function(error) {
                    console.error("Error fetching jobs count:", error);
                }
            ...
            $.ajax({
                ...
                dataType: 'json',
                success: function(response) {
                    console.log("Jobs Count:", response.applicantCount);
                    // Use the count as needed, for example:
                    $('#applicantsCount').text(response.applicantCount);
                },
                error: function(error) {
                    console.error("Error fetching jobs count:", error);
                }
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    pendingSchoCount: true,
                    ownerId: null
                }, // You can specify an ownerId if needed
                dataType: 'json',
                success: function(response) {
                    console.log("Jobs Count:", response.pendingSchoCount);
                    // Use the count as needed, for example:
                    $('#pendingScholarCount').text(response.pendingSchoCount);
                },
                error: function(error) {
                    console.error("Error fetching jobs count:", error);
                }
