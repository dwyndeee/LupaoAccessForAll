            ...
            <li class="nav-item active">
                ...
                <div id="collapsePagesUsers" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="admin.approved-registration.php">Approved Registration</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Approved Registrations</h1>
                    <p class="mb-4">This page shows all the approved registrations in the system Application within Lupao.</p>

                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-check"></i> Approved Application</h6>
                        </div>
                        <div class="card-body">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success === true) {
                        let users = response.approvedRegistrationData;
                        let tbody = $('#dataTable2 tbody');
                        tbody.empty();
                        console.log(response);

                        users.forEach(function(user, index) {
                            let statusText = user.status === null ? 'Pending' : (user.status == 1 ? 'Approved' : (user.status == 3 ? 'Disabled' : 'Rejected'));
                            ...
                            let buttonHtml = '';
                            if (user.status == 3) {
                                buttonHtml = `<button class="btn btn-success btn-enable" data-id="${user.id}" data-name="${user.firstname + " " + user.lastname}">Enable</button>`;
                            } else {
                                buttonHtml = `<button class="btn btn-warning btn-disable" data-id="${user.id}" data-name="${user.firstname + " " + user.lastname}">Disable</button>`;
                            }
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            type: 'POST',
                            data: {
                                registrationAction: 'disableUser',
                                userId: userId,
                                userName: userName
                            },
                            dataType: 'json',
