...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">This page shows your recent activities, and you can also search them by the keywords "Delete", "Update" and "Add"</p>

                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-list"></i> My Recent Activities</h6>
                            <button class="clearLogs btn btn-danger btn-sm" id="clearLogs_btn" type="button" data-user-id=<?php echo $id ?> data-bs-toggle="modal" data-bs-target="#clearLogs-Modal"><i class="fas fa-trash me-1"></i> Clear Logs</button>
                        </div>
                        <div class="card-body">
    ...
    <!-- DELETE MODAL -->
    <div class="modal fade" id="clearLogs-Modal" tabindex="-1" aria-labelledby="clearLogs-Modal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title fs-5">Clear Logs</h4>
                ...
                <div class="modal-body">
                    ...
                    <form id="clearLogForm" method="post">
                        <p id="deleteMessage">Are you sure you want to delete all your recent activities ?</p>
                        <input hidden id="userId" enctype="multipart/form-data" name="userId">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success === true) {
                        let userLogDetails = response.userLogDetails;
                        let tbody = $('#dataTable2 tbody');
                        tbody.empty();
                        userLogDetails.forEach(function(userLogDetails, index) {

                            // Formatting the date and time
                            let date = new Date(userLogDetails.date);
                            let optionsDate = {
                                year: 'numeric',
                                month: '2-digit',
                                day: '2-digit'
                            ...
                            // Assuming userLogDetails.time contains the time in 24-hour format (e.g., "14:30:00")
                            let [hours, minutes, seconds] = userLogDetails.time.split(':');
                            let period = hours >= 12 ? 'PM' : 'AM';
                            hours = hours % 12 || 12; // Convert "0" hour to "12" for AM
                            let formattedTime = `${hours}:${minutes}:${seconds} ${period}`;

                            let row = `<tr>
                                <td>${userLogDetails.id}</td>
                                <td>${userLogDetails.activity_name}</td>
                                <td>${formattedDate}</td>
                                <td>${formattedTime}</td>
                            </tr>`;
                            tbody.append(row);
            ...
            $(document).on('click', '#clearLogs_btn', function() {
                let userId = $(this).data('user-id');
                console.log(userId);
                $('#userId').val(userId);
            });

            $('#clearLogForm').on('submit', function(event) {
                event.preventDefault();

                var formData = new FormData(this);
                formData.append('clearLogs', true);
