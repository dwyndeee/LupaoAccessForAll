        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePagesScholarship" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="">Scholarship Programs</a>
                        <a class="collapse-item" href="">Scholar List</a>
                        <a class="collapse-item" href="">Pending Application</a>
                        <a class="collapse-item" href="">Rejected Application</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePagesEmployment" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="">Employer List</a>
                        <a class="collapse-item" href="">Applicant List</a>
                        <a class="collapse-item" href="">Approved Application</a>
                        <a class="collapse-item" href="">Rejected Application</a>
                        <a class="collapse-item" href="">Job Openings</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePagesUsers" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="">All Users List</a>
                        <a class="collapse-item" href="">Pending Registration List</a>
                        <a class="collapse-item" href="">Approved Registration</a>
                        <a class="collapse-item" href="">Rejected Registration</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePagesArchives"
                    aria-expanded="true" aria-controls="collapsePages">
                    <i class="fa fa-archive"></i>
                    <span>Archives</span>
                </a>
                <div id="collapsePagesArchives" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="">Scholarships Archive</a>
                        <a class="collapse-item" href="">Account Archive</a>
                        <a class="collapse-item" href="">Job Opening Archive</a>
                        <a class="collapse-item" href="">Announcements Archive</a>
                    </div>
                </div>
            </li>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">525</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Overview
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Most User (per type)</h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        ...
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Employer
                                        </span>
                                        <span class="mr-2">
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-4">
                                    <div class="card bg-primary text-white shadow">
                                        <div class="card-body">
                                            Primary
                                            <div class="text-white-50 small">#0B3677</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-4">
