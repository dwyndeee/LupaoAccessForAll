            ...
            <li class="nav-item active">
                ...
                <div id="collapsePagesEmployment" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="employer.applicant.rejected.php">Rejected Application</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Rejected Job Application</h1>
                    <p class="mb-4">This page shows all the Rejected Job Application within Lupao, and you can also filter them by the company they belong.</p>

                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-list"></i> Rejected Application List</h6>
                        </div>
                        <div class="card-body">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    getRejectedJobApplications: true,
                    employer_id: employer_id
                },
                dataType: 'json',
                success: function(response) {
                    if (response.success === true) {
                        let rejectedJobApplications = response.rejectedJobApplicationsData;
                        let tbody = $('#dataTable2 tbody');
                        tbody.empty();
                        rejectedJobApplications.forEach(function(rejectedJobApplications, index) {

                            let statusText = rejectedJobApplications.status === null ? 'Pending' : (rejectedJobApplications.status == 1 ? 'Approved' : 'Rejected');

                            let row = `<tr>
                                <td>${rejectedJobApplications.id}</td>
                                <td>${rejectedJobApplications.applicant}</td>
                                <td>${rejectedJobApplications.company}</td>
                                <td>${rejectedJobApplications.position}</td>
                                <td>
                                    ${statusText}
                                </td>
                                <td>${rejectedJobApplications.approved_on}</td>

                                <td>
                                    <button class="btn btn-danger btn-delete" data-id="${rejectedJobApplications.id}">Delete</button>
                                </td>
            ...
            $(document).on('click', '.btn-delete', function() {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "Do you want to delete this job application?",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            type: 'POST',
                            data: {
                                deleteRejectedJobApplication: true,
